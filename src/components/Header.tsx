      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/about" className="font-sans font-bold text-sm text-zinc-700 hover:text-lime-600 tracking-wide">About</Link>
            <Link to="/research" className="font-sans font-bold text-sm text-zinc-700 hover:text-lime-600 tracking-wide">Research</Link>
            
            <div className="relative group">
              <span className="font-sans font-bold text-sm text-zinc-700 hover:text-lime-600 tracking-wide cursor-pointer">Members</span>
            ...
            <Link to="/contact" className="font-sans font-bold text-sm text-zinc-700 hover:text-lime-600 tracking-wide">Contact</Link>
          </nav>
